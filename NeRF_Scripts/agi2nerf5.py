...
class Agi2NeRF():
    def __init__(self, 
                 xml_path: str, img_folder: str, output_path: str, mesh_path: str = None, data_type: str = "insta", split: bool = False): # remove ply_path, add split
    ...
    class Process_Images():
                    ...
                    if self.cal_percentage_with_mask:
                        ...
                        if percentage >= percentage_threshold:
                            ...
                            if save_mask:
                                ...
                                crop_mesh.raycastscene.merge_mask(path = merged_path)
        ...
        def set_cam_param(self, K_xml:list, new_width: int = 2000, new_height:int = 2000, fovX: float = 0.8, method: str = "undistort_fisheye", rad = np.pi / 4):
            ...
            if method == "undistort_fisheye":
                ...
                self.undistort_cams = undistort_single_cam_opencv(workspace = self.oc.outraw_folder, data_type= self.oc.data_type)
                ...
                self.fish2multi_cams = Fisheye2Multiples(workspace = self.oc.outraw_folder, data_type= self.oc.data_type, rad = rad)
        ...
        def remove_raw_folder(self):
            shutil.rmtree(self.oc.outraw_folder)
